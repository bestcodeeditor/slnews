<template>
  <div class="md-layout md-alignment-center" style="margin: 4em 0">
    ...
    <md-toolbar class="fixed-toolbar" elevation="1">
      ...
      <nuxt-link class="md-primary md-title" to="/">SLnews</nuxt-link>
    ...
    <md-drawer md-fixed :md-active.sync="showLeftSidepanel">
      ...
      <md-field>
        ...
        <md-select @input="changeCountry" :value="country" name="country" id="country">
          <md-option value="in">India</md-option>
      ...
      <md-empty-state
        ...
        md-icon="bookmarks"
        md-label="No Bookmarks in notebook"
        md-description="Login to create bookmarks"
      >
    ...
    <md-drawer class="md-right" md-fixed :md-active.sync="showRightSidepanel">
      ...
      <md-list>
        <md-subheader class="md-primary">Choose your interest</md-subheader>
...
export default {
  data: () => ({
    ...
    newsCategories: [
      ...
      { name: "Technology", path: "technology", icon: "laptop" },
      { name: "Business", path: "business", icon: "home" },
      ...
      { name: "Sports", path: "sports", icon: "sports_soccer" },
      { name: "Limelight", path: "general", icon: "language" }
    ],
    query: "",
    fromDate: "",
    toDate: "",
